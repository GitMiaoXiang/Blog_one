...
<head>
    ...
    <%
        ...
        String path_tag=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()+"/";
    %>
</head>
<body>
                                    ...
                                    <c:when test="${article.src!=null}">
                                        <div class="blog_post_preview animate" data-anim-type="fadeInLeft" data-anim-delay="300">
                                            <div class="blog_post_image">
                                                <a href="post_fullwidth.html"><img src="${article.src}" alt="" /></a>
                                            </div>
                                    ...
                                    <c:when test="${article.src==null}">
                                        ...
                                        <div class="blog_post_preview animate" data-anim-type="fadeInLeft" data-anim-delay="300">
                                            <div class="blog_content">
                                                ...
                                                <p>${article.descz}<a href="http://localhost:8081/managerblog/web/${article.id}/${article.category}/detaliAr.html" class="read_more">查看更多</a></p>
                                            </div>
                                        </div>
                                    </c:when>
                                </c:choose>
