...
jQuery(document).ready(function(){
	...
	jQuery('body').append('<div class="demo_panel opacity '+show_panel+'"><a href="javascript:void(0)" class="panel_toggler"></a><span class="panel_title">设置</span><div class="demo_panel_body"></div></div>');
	demo_panel_main = jQuery('body').find('.demo_panel');
	demo_panel = jQuery('body').find('.demo_panel_body');
	
	demo_panel.append('<div class="panel_headers"><div class="panel_sub-title">导航栏</div><div class="panel_toggle_wrapper"><div class="panel_item header_item"><a href="javascript:void(0)" rel="type1">默认</a></div><div class="panel_item header_item"><a href="javascript:void(0)" rel="type2">主题2</a></div></div></div>');
